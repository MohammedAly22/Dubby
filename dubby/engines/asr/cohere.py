...
class CohereTranscribeEngine(ASREngine):
    info = EngineInfo(
        ...
        family="core",
        description="Cohere's 2B open ASR model (#1 on the Open ASR leaderboard at release), 14 languages. Silero VAD chunks + wav2vec2 word alignment.",
        source_languages=["en", "ar", "es", "fr", "it", "zh", "ja"],
